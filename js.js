...
inputPosistion = alph.indexOf(rotor1[(inputPosistion  + rotor1Index) % 26]) - rotor1Index;
...
console.log("step 7: " + inputPosistion);
  ...
  result += alph[rotor1.indexOf(alph[inputPosistion % 26]) - rotor1Index]
